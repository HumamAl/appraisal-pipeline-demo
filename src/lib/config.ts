...
export const APP_CONFIG = {
  appName: "ValuationOps",                        // Display name (header, page title)
  projectName: "Appraisal Pipeline",              // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,              // null — never render "null"
  domain: "appraisal-tech",                       // Domain classification
  aesthetic: "linear" as AestheticProfile,        // Drives data-theme="..." on <html>
  demoFormat: "admin-console" as DemoFormat,      // Full-width dense layout, no sidebar
